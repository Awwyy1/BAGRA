...
const priceData = [
  { name: "МУЖСКАЯ СТРИЖКА / БРИТЬЁ ГОЛОВЫ", prices: [1000, 1500, 2500] },
  { name: "МОДЕЛИРОВАНИЕ БОРОДЫ / БРИТЬЁ", prices: [800, 1200, 2200] },
  { name: "СТРИЖКА МАШИНКОЙ (2 НАСАДКИ)", prices: [800, 1000, 1500] },
  { name: "КАМУФЛЯЖ СЕДИНЫ", prices: [800, 1000, 1500] },
  { name: "ЧЁРНАЯ МАСКА", prices: [800, 1000, 1500] },
  { name: "ДЕТСКАЯ СТРИЖКА (ДО 10 ЛЕТ)", prices: [1000, 1000, 1000] },
  { name: "УХОД ЗА КОЖЕЙ ГОЛОВЫ", prices: [800, 1000, 1500] },
  { name: "КОРРЕКЦИЯ ВОСКОМ", prices: [500, 500, 600] },
  { name: "УХОД ЗА ЛИЦОМ", prices: [800, 1000, 1500] },
];
