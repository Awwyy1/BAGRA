...
export const Masters: React.FC = () => {
  ...
  return (
    <section id="masters" ref={targetRef} className="relative h-[300vh] bg-[#0A0A0A]">
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        <div className="px-8 md:px-24 mb-12">
            <h2 className="text-8xl md:text-[12vw] font-black tracking-tighter leading-none opacity-10">MASTERS</h2>
            <div className="absolute top-1/2 left-8 md:left-24 -translate-y-1/2 z-10 pointer-events-none">
        ...
        <motion.div style={{ x }} className="flex gap-8 px-8 md:px-24">
          {masters.map((master, idx) => (
            <div 
              key={idx} 
              className="relative min-w-[300px] md:min-w-[500px] aspect-[3/4] group overflow-hidden bg-[#111]"
              data-cursor="text"
