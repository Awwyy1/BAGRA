      ...
      >
        <div className="space-y-8 md:space-y-12 order-2 md:order-1">
            ...
            <motion.div className="space-y-6 md:space-y-8 max-w-lg">
                ...
                <p className="text-xs md:text-sm opacity-50 uppercase tracking-widest">
        ...
        >
          ...
          <div className="absolute top-0 right-0 p-4 md:p-8 text-[10px] uppercase tracking-widest opacity-20">01 / Culture</div>
        </motion.div>
      </motion.div>
    </section>
  );
